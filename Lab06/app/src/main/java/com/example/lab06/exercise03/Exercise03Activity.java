package com.example.lab06.exercise03;
...
import com.example.lab06.exercise02.Exercise02Activity;
...
public class Exercise03Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercise03_activity_main);
    ...
    private void initData() {
        ...
        mAdapter = new EventAdapter(this, R.layout.exercise03_row_layout, mData);
    ...
    private void showConfirmDialog() {
        ...
        builder.setPositiveButton("OK", new OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(Exercise03Activity.this, "The selected phone is deleted!", Toast.LENGTH_LONG).show();
            }
        });
